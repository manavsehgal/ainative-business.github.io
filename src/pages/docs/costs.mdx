...
title: "Cost & Usage"
description: "Cross-runtime spend visibility, token trends, budget state, and auditability across Claude and Codex activity in Stagent."
---
...
The cost and usage view gives operators a shared ledger for Claude and Codex activity. Instead of inferring spend from provider-specific logs, Stagent surfaces spend, tokens, budget health, runtime share, and model concentration in one governed screen.

<BrowserFrame src="/screenshots/cost-usage-list.png" alt="Cost and usage dashboard with budget pacing, spend metrics, runtime counts, and Anthropic/OpenAI pricing table" />
...
- **Runtime Breakdown** — See how much filtered spend and token usage came from Claude Agent SDK work versus Codex App Server work.
