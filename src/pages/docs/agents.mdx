...
<BrowserFrame src="/screenshots/profiles-detail.png" alt="Marketing Strategist profile detail with identity, configuration, runtime coverage, tools and policy" />
