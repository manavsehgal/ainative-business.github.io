...
- **Bidirectional Channel Conversations** — Chat with Stagent agents directly from Slack or Telegram. Channel conversations use the same engine with full tool access and permission handling, and appear in the sidebar alongside in-app chats.
