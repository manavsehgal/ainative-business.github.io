...
- **Browser layer** — React 19 with 35 operator surfaces, real-time SSE streaming
- **Server layer** — Next.js 16 with 20 service modules, 114 API endpoints
- **External layer** — Local SQLite database (WAL mode, 40+ tables), no cloud dependency
...
| Capability | Status |
|-----------|--------|
| 124 features across 35 operator surfaces | Shipped |
