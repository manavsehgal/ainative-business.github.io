...
- **Browser layer** — React 19 with 37 operator surfaces, real-time SSE streaming
- **Server layer** — Next.js 16 with 26 service modules, 134 API endpoints
- **External layer** — Local SQLite database (WAL mode, 44+ tables), no cloud dependency

Technology stack: TypeScript (86% of codebase), Tailwind CSS v4, shadcn/ui, Drizzle ORM. Open source under Apache 2.0.

### What's Shipped Today

| Capability | Status |
|-----------|--------|
| 128 features across 37 operator surfaces | Shipped |
...
| Living Book (12 chapters across 4 parts, self-regenerating from source code) | Shipped |
