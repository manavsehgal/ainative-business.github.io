...
<div class="my-16 py-12 border-y border-border/50">
  <p class="text-center text-text-muted text-sm mb-6">
    Stagent is under active development. Join the waitlist to be notified when it's ready for download.
  </p>
  <WaitlistForm variant="cta" id="research-mid-waitlist" />
</div>
...
<div class="my-16 py-12 border-y border-border/50">
  <p class="text-center text-text-muted text-sm mb-6">
    Be the first to know when Stagent is ready for download.
  </p>
  <WaitlistForm variant="cta" id="research-end-waitlist" />
</div>
