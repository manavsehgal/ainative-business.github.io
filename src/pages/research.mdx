...
<Figure number={1} caption="Four-layer agent stack — each layer solves its own problems but leaves gaps at the layer above. The harness layer (dashed) is where Stagent operates.">
  <LayerStack class="w-full max-w-[280px] text-text-muted" />
</Figure>
...
<Figure number={2} caption="Concentric consumption model — Stagent at center consumes infrastructure, application, and orchestration layers as commodity inputs.">
  <HarnessOrbit class="w-full max-w-[400px] text-text-muted" />
</Figure>
...
<Figure number={3} caption="Four-tier memory architecture — working memory (amber, volatile) narrows at the top; procedural memory (stable, accumulated) broadens at the base.">
  <MemoryTiers class="w-full max-w-[320px] text-text-muted" />
</Figure>
...
<Figure number={4} caption="Graduated autonomy gauge — trust increases from supervised to autonomous as agents demonstrate competence on specific task types.">
  <AutonomyLevels class="w-full max-w-[420px] text-text-muted" />
</Figure>
...
<Figure number={5} caption="Protocol hierarchy — core protocols (amber) form the communication backbone; non-core protocols provide fallback and integration.">
  <ProtocolStack protocols={protocols} class="w-full max-w-[340px] text-text-muted" />
</Figure>
...
<Figure number={6} caption="Competitive positioning on Cloud-Desktop and Reactive-Autonomous axes. Stagent (amber) occupies the desktop-autonomous quadrant uniquely.">
  <PositioningGrid class="w-full max-w-[440px] text-text-muted" />
</Figure>
...
<Figure number={7} caption="Gantt-style roadmap — four staggered phases from foundation (months 0-3) through ecosystem (months 9+). Decreasing opacity reflects increasing speculativeness.">
  <RoadmapTimeline class="w-full max-w-[510px] text-text-muted" />
</Figure>
