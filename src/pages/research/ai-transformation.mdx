...
- **Browser layer** — React 19 with 42 operator surfaces, real-time SSE streaming
- **Server layer** — Next.js 16 with 35 service modules, 173 API endpoints
- **External layer** — Local SQLite database (WAL mode, 46+ tables), no cloud dependency
...
| Capability | Status |
|-----------|--------|
| 198 features across 42 operator surfaces | Shipped |
