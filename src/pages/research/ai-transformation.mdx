...
<Figure number={8} caption="Cost & Usage — Cross-Runtime Spend Visibility and Budget Controls">
  <BrowserFrame src="/screenshots/cost-codex-claude-code.png" alt="Cost and usage dashboard with budget pacing, spend metrics, provider counts, and pricing tables" />
</Figure>
